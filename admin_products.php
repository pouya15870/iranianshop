...
<form name="add_product" action="action_admin_products.php<?php if (!empty($url))echo($url);?>" method="POST" enctype="multipart/form-data">
 <table style="width: 100%;" border = "0" style="margin-left: auto; marign-right: auto;">
    ...
    <tr>
        ...
        <td><input type="text" id="pro_price" name="pro_price" value="<?php echo ($pro_price) ?>" /></td>
    </tr>
    ...
    <tr>
        ...
        <?php if(!empty($pro_image))
            echo ("<img src='images/products/$pro_image 'width='80px' height='40' />");?>
        </td>
    </tr>
