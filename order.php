...
?>
<br />
<span style ='color:red;'><b>برای خرید پستی محصول انتخاب شده باید واردسایت شوید.</b></span>
<br /><br />
...
کلیک کنید.
<br />
در صورتی که عضو فروشگاه نیستید برای ثبت نام
...
<tr>
    ...
    <td><input type ="text" style = "text-align: right;background-color: lightgray;" id ="pro_name" name = "pro_name"  value = "<?php 
    echo ($row["pro_name"]);?>" readonly /></td>
</tr>
...
<tr>
    ...
    <td><input type ="text" id ="pro_price" name = "pro_price" style = "text-align: left;background-color: lightgray;" value = "<?php
     echo ($row['pro_price']);?>" readonly />ریال</td>
</tr>

<tr>
    <td>مبلغ قابل پرداخت <span style = "color: red;">*</span></td>
    <td><input type ="text" id ="total_price" name = "total_price" style = "text-align: left;background-color: lightgray;" value = "0" 
    readonly />ریال</td>
</tr>
...
<script type = "text/javascript">
    ...
    <tr>
        ...
        <td style = "width: 60%;">
        <input type = "text" id = "realname" name = "realname" value = "<?php echo ($user_row['realname']);?>" style = "background-color: lightgray;"
        readonly /> </td>
    </tr>

    <tr>
        <td>پست الکترونیکی <span style ="color: red;">*</span></td>
        <td><input type = "text" id = "email" name = "email" style = "text-align:left; background-color: lightgray;" value = "<?php echo 
        ($user_row['email']);?>" readonly /> </td>
    </tr>

    <tr>
        <td>شماره تلفن همراه <span style ="color: red;">*</span></td>
        <td><input type = "text" id = "mobile" name = "mobile" style = "text-align:left;" value = "09" /> </td>
    </tr>
...
<table>
    <tr>
        ...
        <img src="images/products/<?php echo $row['pro_image']; ?>" alt="Product Image" width= "250px" height = "120px" />
        <br />
